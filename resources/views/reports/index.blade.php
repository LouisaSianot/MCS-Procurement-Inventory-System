<x-app-layout title="Reports">
    ...
    <section aria-labelledby="procurement-overview-heading">
        <div class="mb-4 flex items-center justify-between">
            <h2 id="procurement-overview-heading" class="text-lg font-bold text-slate-900">Procurement overview</h2><span class="text-sm text-slate-500">Based on purchase orders</span>
        </div>
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
    ...
    <section class="mt-6" aria-labelledby="inventory-heading">
        <div class="mb-4 flex items-center justify-between">
            <h2 id="inventory-heading" class="text-lg font-bold text-slate-900">Inventory summary</h2><span class="text-sm text-slate-500">Current inventory state{{ isset($filters['branch_id']) ? ' for the selected branch' : '' }}</span>
        </div>
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
    ...
    <section class="card mt-6 overflow-hidden" aria-labelledby="low-stock-heading">
        <div class="border-b border-slate-200 px-5 py-4">
            <h2 id="low-stock-heading" class="font-semibold text-slate-900">Low stock</h2>
