...
<aside id="sidebar"
    ...
    <div class="flex h-16 shrink-0 items-center justify-between gap-2 border-b border-slate-200 px-4">
        <a href="{{ route('dashboard.index') }}" class="flex items-center gap-2.5 overflow-hidden">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4">
        ...
        <ul class="space-y-1">
            <li>
                <a href="{{ route('dashboard.index') }}" aria-current="{{ $current === 'dashboard.index' ? 'page' : 'false' }}" class="nav-link">
            ...
            <li>
                <a href="{{ route('receipts.index') }}" aria-current="{{ str_starts_with($current, 'receipts') ? 'page' : 'false' }}" class="nav-link">
                    <i data-lucide="receipt" class="nav-link-icon"></i>
                    <span class="collapsible-label">Receipts</span>
                </a>
            </li>
        </ul>
        ...
        <ul class="space-y-1">
            <li>
                <a href="{{ route('settings.index') }}" aria-current="{{ str_starts_with($current, 'settings') ? 'page' : 'false' }}" class="nav-link">
                    <i data-lucide="settings" class="nav-link-icon"></i>
                    <span class="collapsible-label">Settings</span>
                </a>
            </li>
        </ul>
    </nav>
