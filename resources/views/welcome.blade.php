...
<head>
    ...
    <title>{{ config('app.name', 'Mathematics & Computer Science Procurement & Inventory System') }}</title>
...
<body class="bg-[#FDFDFC] dark:bg-[#1d202d] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div class="text-[24px] leading-[20px] flex-1 p-6 pb-6 lg:p-20 lg:pb-10 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <h1 class="mb-1 font-medium">Mathematics & Computer Science <br>Procurement & Inventory System</h1><br>
                <p class="text-[16px] leading-[24px]"> This web-app was created to help make daily operations easier for our hard working staff. It automates the manual processes and provides a steamlined experience.</p>
            ...
            <div class="bg-[#fff2f2] dark:bg-[#1b1b18] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/364] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
